...
const copy = {
  zh: {
    ...
    mcpTitle: "MCP 服务器",
    mcpDetail:
      "连接 HTTP/SSE 的 MCP 服务器、列出其工具，并可「试运行」让模型实际调用（暂未接入主对话）。",
    ...
    mcpRunPlaceholder: "试运行：让模型用该服务器的工具回答一句话…",
    mcpRun: "试运行",
    mcpRunning: "运行中…",
    mcpRunFailed: "运行失败",
    mcpRunRounds: "轮",
    mcpRunToolCalls: "次工具调用",
    archiveAction: "归档",
    unarchiveAction: "恢复",
    archivedTitle: "已归档对话",
  ...
  en: {
    ...
    mcpDetail:
      "Connect HTTP/SSE MCP servers, list their tools, and dry-run them so the model actually calls the tools (not yet wired into chat).",
    ...
    mcpRunPlaceholder: "Dry run: ask the model to answer using this server's tools…",
    mcpRun: "Dry run",
    mcpRunning: "Running…",
    mcpRunFailed: "Run failed",
    mcpRunRounds: "rounds",
    mcpRunToolCalls: "tool calls",
